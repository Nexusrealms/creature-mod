...
public class LangProvider extends FabricLanguageProvider {
    ...
    private void generateEntityTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder){
        ...
        generateEntityTranslationWithSpawnEgg(wrapperLookup, translationBuilder, ModEntities.WATER_ELEMENTAL, "Water Elemental");
    ...
    private void generateMessageTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder){
        ...
        translationBuilder.add("message.creature-mod.incantation.success", "Successfully invoked %s!");
        translationBuilder.add("message.creature-mod.incantation.failure", "Could not find any spell for %s!");
    }
